  ...
  return (
    <div className="view-stack">
      ...
      <section className="panel risk-panel">
        <div className="panel-heading">
          <div>
            <p className="eyebrow">API risk</p>
            <h2>Индекс риска API-метода</h2>
          </div>
          <button
            type="button"
        ...
        {riskHelpOpen && (
          <div className="info-note">
            <strong>Что показывает эта статистика:</strong> таблица оценивает текущее состояние API-методов за выбранный
            период. «Микросервис» и «Метод» определяют анализируемую операцию. «Индекс риска» — итоговая оценка
            неблагоприятного состояния метода, а «Уровень» — ее словесная категория. «Запросы» — число уникальных
      ...
      <section className="panel risk-panel">
        ...
        {degradationHelpOpen && (
          <div className="info-note">
            <strong>Что показывает эта статистика:</strong> таблица помогает найти API-методы, которые сильнее всего
